				...
				<header class="bg-white shadow">
					<nav class="container mx-auto flex items-center justify-between px-6 py-4">
						<div class="flex items-center">
							<a href="/" class="text-xl font-bold text-indigo-600 mr-6">YGO Draft</a>
						...
						<div class="flex items-center">
							<a href="https://github.com/a-ws-m/ygo-draft" target="_blank" class="mr-4" aria-label="GitHub">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="text-gray-700 hover:text-indigo-600">
